define([], function () {
  return {
    "AboutContentLabel": "Our Collaboration Champions Network was created with organisational Champions / Adoption Specialists in mind. Hearing from the Microsoft 365 Champion Community this app was developed to deliver a platform to help create and sustain your own communities. Starting with inspiration through execution in helping you achieve more within your own communities!",
    "AboutHeaderLabel": "About the Collaboration Champions Network (CNN):",
    ...
    "AppHeaderTitleLabel": "Collaboration Champions Network",
    "AppLogoToolTip": "Home",
    "ApplyButton": "Apply",
    ...
    "ChampionLeaderBoardLabel": "Champions LeaderBoard",
    ...
    "ChatIconLabel": "Chat",
    "CMPBreadcrumbLabel": "Collaboration Champions Network",
    ...
    "DateLabel": "Date",
    "DateofEventGridLabel": "Date of Activity",
    ...
    "EventApprovalsEnableLabel": "Enable Champion Activity Approvals",
    "EventApprovedMessage": "Champion Activity(s) Approved.",
    "EventLabel": "Activity",
    "EventRejectedMessage": "Champion Activity Rejected.",
    "EventsApprovalInfoIconTooltipContent": "Enabling this option will require the activity submissions by champions to be approved by an admin. The points for the activitys will be awarded only after the approval.",
    "EventsListLabel": "Activity List",
    "EventsListToolTip": "Accessing Activity List",
    "EventsSelectedLabel": "Activities selected.",
    "EventsSubmissionSuccessMessage": "Activity recorded successfully.",
    "EventsSubmitMessage": "When you are done adding activities, please click on Submit button to save.",
    "EventsTrackListLabel": "Activities Track List",
    "EventSubmissionPendingMessage": "Activity submitted for approval. Points will be awarded once the activities are approved.",
    "EventTrackListToolTip": "Accessing Activity Track List",
    "EventTypeGridLabel": "Type",
    "EventTypeGridLabelPlaceHolder": "Select Activity Type",
    "EventTypeLabel": "Activity Type",
    "EventTypeValidationMessage": "Please select activity type!",
    ...
    "RankLabel": "Rank",
    "RecordEventLabel": "Record Activity",
    ...
    "VisitLabel": "Visit the Collaboration Champions Network pages to learn more:",
